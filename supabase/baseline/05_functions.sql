...
-- sa_top_medicos: refleja el estado vivo en prod tras 5.D-2 (normalización de
-- nombres). Compone `nombre` desde los campos estructurados de profiles, con
-- role check dual y LANGUAGE plpgsql (introducidos en
-- 20260427_b1_02_sa_functions_role_check.sql y conservados en
