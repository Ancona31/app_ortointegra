...
export async function proxy(request: NextRequest) {
  ...
  const publicApiPaths = ['/api/google/callback', '/api/stripe/webhook', '/api/stripe/checkout', '/api/stripe/portal', '/api/auth/registro', '/api/auth/complete-registro', '/api/auth/email-hook', '/api/auth/verify-email']
