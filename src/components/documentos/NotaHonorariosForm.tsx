...
export default function NotaHonorariosForm({ pacienteInicial = '', pacienteId }: Props) {
  ...
  async function imprimir() {
    // Validación temprana ANTES de cualquier side-effect
    ...
    // 2. Identidad — UUID v4 puro como clientId (el folio NOH-/COT-
    //    queda en contenido pero no es verificable públicamente)
