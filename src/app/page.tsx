    ...
    <main className="min-h-screen relative" style={{ fontFamily: 'system-ui, -apple-system, sans-serif', WebkitFontSmoothing: 'antialiased' }}>
      ...
      <section className="pb-20 sm:pb-28">
        ...
        <div className="relative overflow-hidden group/marquee">
          {/* Fade edges */}
          <div className="absolute left-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-r from-white/50 to-transparent z-10 pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-l from-white/50 to-transparent z-10 pointer-events-none" />
      ...
      <section className="border-t border-slate-200/60 bg-white/50 backdrop-blur-md">
      ...
      <section className="bg-[#f8fafc]/50 backdrop-blur-md">
        <div className="mx-auto max-w-6xl px-4 sm:px-8 py-20 sm:py-28">
