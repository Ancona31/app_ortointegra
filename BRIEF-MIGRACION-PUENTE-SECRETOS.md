...
| A5 | `src/app/api/google/callback/route.ts` | El alta es **una** llamada (`altaConexion`), no un INSERT más un RPC. Maneja `clinica_ya_conectada` → `?gcal_error=clinica_ya_conectada` (plan §2.5). |
